    ...
    <div className="container">
      ...
      <section className="glass p-8">
        <div className="content-center space-large">
          ...
          <p className="text-lg opacity-90">Share your thoughts on our latest releases</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="glass p-6 text-center mb-6">
            ...
            <p className="text-sm opacity-90 mb-4">
              Sign in to leave comments and feedback on our releases
            </p>
          ...
          {/* Sample comments to show the feature */}
          <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-1">
                    <span className="font-semibold text-sm">dev_sarah</span>
                    <span className="text-xs opacity-60">2 hours ago</span>
                    <span className="text-xs px-2 py-1 bg-blue-500/20 text-blue-400 rounded">v3.2.0</span>
                  </div>
                  <p className="text-sm opacity-90">
                    The new navbar layout is fantastic! Much cleaner and more intuitive to navigate. 🎉
                  </p>
                  <div className="flex items-center space-x-3 mt-2 text-xs opacity-70">
                    <button className="hover:text-orange-400 transition-colors">👍 3</button>
                    <button className="hover:text-orange-400 transition-colors">Reply</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass p-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-1">
                    <span className="font-semibold text-sm">alex_pm</span>
                    <span className="text-xs opacity-60">5 hours ago</span>
                    <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded">v3.2.0</span>
                  </div>
                  <p className="text-sm opacity-90">
                    Love the FAQ improvements! The expandable sections make it so much easier to find information quickly.
                  </p>
                  <div className="flex items-center space-x-3 mt-2 text-xs opacity-70">
                    <button className="hover:text-orange-400 transition-colors">👍 7</button>
                    <button className="hover:text-orange-400 transition-colors">Reply</button>
                  </div>
                </div>
              </div>
            ...
            <div className="glass p-4">
              <div className="flex items-start space-x-3">
                <div className="w-8 h-8 bg-gradient-to-br from-orange-400 to-red-500 rounded-full flex-shrink-0"></div>
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-1">
                    <span className="font-semibold text-sm">marcus_dev</span>
                    <span className="text-xs opacity-60">1 day ago</span>
                    <span className="text-xs px-2 py-1 bg-blue-500/20 text-blue-400 rounded">v3.1.0</span>
                  </div>
                  <p className="text-sm opacity-90">
                    The Stripe integration is seamless! Payment flow works perfectly and the subscription management is intuitive.
                  </p>
                  <div className="flex items-center space-x-3 mt-2 text-xs opacity-70">
                    <button className="hover:text-orange-400 transition-colors">👍 12</button>
                    <button className="hover:text-orange-400 transition-colors">Reply</button>
                  </div>
                </div>
              </div>
